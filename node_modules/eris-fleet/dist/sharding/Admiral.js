...
import { errorToJSON, reconstructError } from "../util/ErrorHandler.js";
/**
...
export class Admiral extends EventEmitter {
    ...
    */
    constructor(options) {
        ...
        this.eris = new (this.erisClient ?? Eris)(this.token);
        this.launch();
        if (master.isMaster) {
    ...
    launch() {
        ...
        if (master.isMaster) {
            process.on("uncaughtException", (e) => this.log(e, "error"));
            process.nextTick(() => {
